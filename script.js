const backgroundColourOptions = [
  ...
  {
    "themeClass": 'blush-dark',
    "description": "Blush Dark",
    "thumbnailColor1": "#D14D72",
    "thumbnailColor2": "#D14D72",
  },
  {
  ...
  {
    "themeClass": "light-yellow",   
    "description": "Light Yellow",
    "thumbnailColor1": "#FFF2CC",
    "thumbnailColor2": "#FFF2CC",
  },
  {
  ...
  },
  {
    "themeClass": 'mocha',
    "description": 'Mocha',
    "thumbnailColor1" : '#867070',
    "thumbnailColor2" : '#D5B4B4',
  }, 
  {
  ...
  {
    "themeClass": 'neon-green',
    "description": 'Neon green',
    "thumbnailColor1" : '#B8F1B0',
    "thumbnailColor2" : '#00FFAB',
  }, 
  {
    "themeClass": 'calm-purple',
    "description": "Calm Purple",
    "thumbnailColor1": "#e5e6ff",
    "thumbnailColor2": "#B1B2FF",
  },
  {
    "themeClass": 'purple',
    "description": 'Purple',
  ...
  {
    "themeClass": 'stormy-night',
    "description": "Stormy Night",
    "thumbnailColor1": "#191825",
    "thumbnailColor2": "#413543",
  },
...
let stopTime;
let newElapsed;
let pomodoroTitleOriginal = document.title;
...
function updateDisplay() {
  ...
  if(isClockRunning) {
    document.title = hour > 0 ? hour + ":" + min +":" + seconds : min +":" + seconds + ' - ' + pomodoroTitleOriginal;
  } else {
    document.title = pomodoroTitleOriginal;
  }  
}
